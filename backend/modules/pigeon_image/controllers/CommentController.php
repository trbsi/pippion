...
class CommentController extends Controller
{
	...
	*/
    ...
    public function actionCreate()
    {
		...
		if(isset($_POST["idimage"])  && isset($_POST["comment_text"]))
		{
			$model = new Comment();
			$model->IDimage=(int)$_POST["idimage"];
			$model->IDuser=Yii::$app->user->getId();
			$model->comment=$_POST["comment_text"];
			$model->date_created=ExtraFunctions::currentTime("ymd-his"); //UTC
	
			if ($model->save()) 
			{
				echo json_encode(['result'=>'true', 'comment'=>$model->comment]);
